...
module.exports = {
    ...
    obtenirTousTacheBD: (userID, estComplet) => {
        return new Promise((resolve, reject) => { 
            ...
            const query = "SELECT taches.*, sous_taches.* FROM public.taches LEFT JOIN public.sous_taches ON public.taches.id = public.sous_taches.tache_id WHERE utilisateur_id = $1;"
            const values = [userID];
